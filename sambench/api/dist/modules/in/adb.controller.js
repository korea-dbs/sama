...
let AdbController = class AdbController {
    ...
    async executeSqliteQuery(sql) {
        ...
        return this.shell(`echo '${fixedQuery}' | /data/local/sqlite_vanilla ${const_1.AndroidPath.ExternalDB}`);
    }
    async executeSqliteQueryBenchmark(sql) {
        ...
        try {
            const fixedQuery = sql.replace(/'/g, '"');
            const androidShellCommand = `(echo '${fixedQuery}' | time /data/local/sqlite_vanilla ${const_1.AndroidPath.ExternalDB}) 2>&1`;
    ...
    async generateStorageBatch(batches, imgRatio, xmpRatio) {
        ...
        for (const source in sourceCounts) {
            ...
            for (let i = 0; i < count; i++) {
                ...
                const dest = `/sdcard/DCIM/batch/${indexString}-${fileName}`;
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AdbController.prototype, "getDbs", null);
__decorate([
    (0, common_1.Get)('db/max_dis'),
    openapi.ApiResponse({ status: 200, type: String }),
    __param(0, (0, common_1.Query)('dbPath')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdbController.prototype, "getDbDistance", null);
__decorate([
    (0, common_1.Get)('db/cal_blk_offset'),
    openapi.ApiResponse({ status: 200, type: String }),
    __param(0, (0, common_1.Query)('dbPath')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdbController.prototype, "getCalBlkOffset", null);
__decorate([
    (0, common_1.Get)('db/frag_count'),
    openapi.ApiResponse({ status: 200, type: String }),
    __param(0, (0, common_1.Query)('dbPath')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdbController.prototype, "getFragCount", null);
